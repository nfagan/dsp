function looks = dsp__get_combined_looking_measures( behav, trial_fields )

%   Convert a matrix of behavioral data to a vector, where each element is
%   identified by a) the type of looking (counts or gaze quantity), b) the
%   period of looking (early vs. late), and c) the object of looking
%   (bottle vs. monkey)
%
%   IN:
%     - `behav` (Container) -- Behavioral data as loaded with DSP_IO();
